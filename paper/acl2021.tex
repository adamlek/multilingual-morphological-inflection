...
\usepackage{pgfplotstable}
    ...
    \pgfplotstableread{
        lang natural hallucinated acc1 acc2
        tur	100310 0 98.85 98.86
        olo	100062 0 99.35 99.37
        vep	100053 0 99.33 99.24
        sah	100046 0 99.87 99.84
        por	100041 0 98.37 98.63
        pol	100039 0 97.47 98.01
        ara	100027 0 98.58 89.72
        tyv	100015 0 98.49 98.65
        kmr	100003 0 98.31 98.30
        rus	100002 0 96.86 97.1
        spa	100001 0 98.66 98.48
        aym	100000 0 99.80 99.83
        deu	100000 0 93.25 94.41
        ces	94169 0 93.96 93.77
        krl	78673 0 97.87 98.16
        bul	39011 0 98.04 90.57
        nld	38827 0 92.33 93.63
        amh	32254 0 97.11 97.57
        heb	23204 0 95.0 96.13
        afb	22165 0 91.16 90.85
        arz	17683 0 92.52 92.36
        cni	13948 0 91.43 92.65
        ckb	11577 0 71.72 86.5
        ind	11072 0 61.94 70.24
        evn	5216 10000 52.17 51.08
        see	3801 10000 52.42 76.21
        ame	2524 10000 74.17 67.11
        itl	1246 10000 31.31 60.3
        syc	1217 10000 15.7 27.33
        bra	1082 10000 62.09 62.09
        ail	918 10000 91.98 93.28
        mag	854 10000 63.64 70.25
        vro	804 10000 78.07 80.7
        kod	323 10000 80.43 82.61
        sjo	290 10000 36.59 46.24
        gup	214 10000 26.67 33.33
        ckt	132 10000 55.56 61.11
        lud	128 10000 66.67 72.22
    }\testdata
...
\begin{tikzpicture}
    ...
    \begin{axis}[      
      ...
      \addplot [red]
          table [y=acc1, meta=lang, x expr=\coordindex] {\testdata};
                    %\addlegendentry{acc}
      %\addplot [blue]
      %    table [y=acc2, meta=lang, x expr=\coordindex] {\testdata};
      %              %\addlegendentry{acc}
    \end{axis}
